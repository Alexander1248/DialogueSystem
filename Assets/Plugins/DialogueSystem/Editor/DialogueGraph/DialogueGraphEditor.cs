...
namespace Plugins.DialogueSystem.Editor.DialogueGraph
{
    public class DialogueGraphEditor : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Plugins/DialogueSystem/Editor/DialogueGraph/DialogueGraphEditor.uxml");
        ...
        {
            var graph = Selection.activeObject as Plugins.DialogueSystem.Scripts.DialogueGraph.DialogueGraph;
